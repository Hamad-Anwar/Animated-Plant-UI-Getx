...
# Plant UI App - Flutter

This repository contains a Flutter implementation of a Plant UI app with two screens: Splash and Plants. The app features delightful animations and a beautiful UI to showcase various plants.

## Features

- Attractive Splash screen with animations.
- Plants screen with captivating UI design.
- Stunning animations to enhance the user experience.
